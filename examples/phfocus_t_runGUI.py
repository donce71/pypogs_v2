...
csv_file = r'C:\Pypogs\pypogs-master\pypogs\data\ex_commands.csv'
if path.exists(csv_file):
    command_list = sys.get_external_commands_from_csv(csv_file)
    sys.execute_commands_from_csv(command_list)
